*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZV_FMACTYP
*   generation date: 23.08.2019 at 09:57:06
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZV_FMACTYP          .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZV_FMACTYP'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZV_FMACTYP_EXTRACT
TOTAL = ZV_FMACTYP_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZV_FMACTYP'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZV_FMACTYP-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZV_FMACTYP_EXTRACT
TOTAL = ZV_FMACTYP_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZV_FMACTYP-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZV_FMACTYP'
...
TOTAL = ZV_FMACTYP_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZV_FMACTYP-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZV_FMACTYP-UPD_FLAG NE SPACE.
