*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZV_FMCUSAC
*   generation date: 24.06.2019 at 15:13:13
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZV_FMCUSAC          .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZV_FMCUSAC'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZV_FMCUSAC_EXTRACT
TOTAL = ZV_FMCUSAC_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZV_FMCUSAC'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZV_FMCUSAC-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZV_FMCUSAC_EXTRACT
TOTAL = ZV_FMCUSAC_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZV_FMCUSAC-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZV_FMCUSAC'
...
TOTAL = ZV_FMCUSAC_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZV_FMCUSAC-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZV_FMCUSAC-UPD_FLAG NE SPACE.
