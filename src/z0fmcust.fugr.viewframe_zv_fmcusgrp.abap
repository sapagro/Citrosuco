*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZV_FMCUSGRP
*   generation date: 24.06.2019 at 15:11:29
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZV_FMCUSGRP         .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZV_FMCUSGRP'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZV_FMCUSGRP_EXTRACT
TOTAL = ZV_FMCUSGRP_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZV_FMCUSGRP'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZV_FMCUSGRP-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZV_FMCUSGRP_EXTRACT
TOTAL = ZV_FMCUSGRP_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZV_FMCUSGRP-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZV_FMCUSGRP'
...
TOTAL = ZV_FMCUSGRP_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZV_FMCUSGRP-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZV_FMCUSGRP-UPD_FLAG NE SPACE.
