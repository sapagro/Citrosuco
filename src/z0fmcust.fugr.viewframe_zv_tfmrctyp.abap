*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZV_TFMRCTYP
*   generation date: 30.09.2019 at 12:29:14
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZV_TFMRCTYP         .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZV_TFMRCTYP'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZV_TFMRCTYP_EXTRACT
TOTAL = ZV_TFMRCTYP_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZV_TFMRCTYP'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZV_TFMRCTYP-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZV_TFMRCTYP_EXTRACT
TOTAL = ZV_TFMRCTYP_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZV_TFMRCTYP-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZV_TFMRCTYP'
...
TOTAL = ZV_TFMRCTYP_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZV_TFMRCTYP-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZV_TFMRCTYP-UPD_FLAG NE SPACE.
