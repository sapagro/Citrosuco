REPORT zabs_budget_upload.

INCLUDE zabs_inc_budget_upload_top.
INCLUDE zabs_inc_budget_upload_f01.
...
START-OF-SELECTION.
  ...
  IF lines( t_sheets_out ) > 0.
    IF p_bud IS NOT INITIAL. "Upload Agriplan's Budget Data
      PERFORM agriplan_budget_create USING t_sheets_out.
