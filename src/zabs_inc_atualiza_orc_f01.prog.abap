...
*    WHERE acnum   EQ @p_acnum
*      AND extwg   EQ @ls_processo-extwg
*      AND periodo IN @lrt_periodo.
*
*    IF lt_mensal[] IS NOT INITIAL.
...
*-- Divergência Talhões?
                      IF lines( lt_tplnr_fl ) NE lines( lt_orcamento ).
...
*--------------------------------------------------------------------
                        ...
                        ENDLOOP.
*--------------------------------------------------------------------
*-- Registros devem ser ELIMINADOS da tabela ZABS_ORCAMENTO
                        IF ls_rchdr-matnr(4) EQ 'TFOR'
                        OR ls_rchdr-matnr(4) EQ 'TIMP'.
                          IF lines( lt_orcamento ) GT lines( lt_tplnr_fl ).
                            LOOP AT lt_orcamento INTO DATA(ls_orcamento).
                              READ TABLE lt_tplnr_fl INTO DATA(ls_tplnr_fl)
                                WITH KEY tplnr_fl = ls_orcamento-fazenda BINARY SEARCH.
                              IF sy-subrc NE 0.
                                INSERT INITIAL LINE INTO TABLE gt_update
                                  ASSIGNING FIELD-SYMBOL(<ls_eliminar>).
                                IF sy-subrc EQ 0.
                                  MOVE-CORRESPONDING ls_orcamento TO <ls_eliminar>.
                                  <ls_eliminar>-eliminar = abap_true.
                                ENDIF.
                              ENDIF.
                            ENDLOOP.
                            CLEAR ls_orcamento.
*--------------------------------------------------------------------
*-- Registros devem ser INSERIDOS na tabela ZABS_ORCAMENTO
                          ELSE.
                            ...
                            IF sy-subrc EQ 0.
                              ...
                              WHILE sy-subrc EQ 0.
                                ...
                                IF sy-subrc NE 0.
                                  ...
                                  CLEAR: ls_orcamento_new.
                                  ls_orcamento_new-acnum = p_acnum.
                                  ls_orcamento_new-extwg = ls_matkl-extwg.
                                  ls_orcamento_new-matkl = ls_matkl-matkl.
                                  ls_orcamento_new-rcnum = ls_rchdr-rcnum.
                                  ls_orcamento_new-matnr = ls_zfmrclst-matnr_ins.

                                  CLEAR: lv_auxiliar, lv_passadas, lv_produto.
                                  READ TABLE lt_orcamento INTO DATA(ls_orcamento_ref)
                                    WITH KEY acnum  = p_acnum
                                             extwg  = ls_matkl-extwg
                                             matkl  = ls_matkl-matkl
                                             rcnum  = ls_rchdr-rcnum
                                  ...
                                  IF sy-subrc NE 0.
                                    CLEAR ls_orcamento_ref.
                                  ELSE.
                                    ls_orcamento_new-matnr = ls_zfmrclst-matnr_ins.
                                    ls_orcamento_new-period = ls_period-period.

                                    IF ls_detailed-kostl_manu IS NOT INITIAL.
                                      ls_orcamento_new-kostl = ls_detailed-kostl_manu.
                                    ELSEIF ls_detailed-kostl_form IS NOT INITIAL.
                                      ls_orcamento_new-kostl = ls_detailed-kostl_form.
                                    ENDIF.

                                    ls_orcamento_new-fazenda  = ls_detailed-fazenda.
                                    ls_orcamento_new-passadas = ls_orcamento_ref-passadas.
                                    ls_orcamento_new-rcdos    = ls_zfmrclst-rcdos.

                                    IF ls_zfmrclst-matnr(4) EQ 'TFOR'.
                                      ls_orcamento_new-aarea_form = ls_detailed-aareaform * ls_orcamento_ref-passadas.
*-- Calcula Quantidade de Produto
                                      IF ls_rchdr-ausme EQ 'VC'.
                                        lv_produto = ls_orcamento_ref-passadas * ls_detailed-bombasform * ls_zfmrclst-rcdos.
                                      ELSEIF ls_rchdr-ausme EQ 'HC'.
                                        lv_produto = ls_orcamento_ref-passadas * ls_detailed-aareaform * ls_zfmrclst-rcdos.
                                      ENDIF.
                                    ELSEIF ls_zfmrclst-matnr(4) EQ 'TMAN'.
                                      ls_orcamento_new-aarea_manu = ls_detailed-aareamanu * ls_orcamento_ref-passadas.
*-- Calcula Quantidade de Produto
                                      IF ls_rchdr-ausme EQ 'VC'.
                                        lv_produto = ls_orcamento_ref-passadas * ls_detailed-bombasmanu * ls_zfmrclst-rcdos.
                                      ELSEIF ls_rchdr-ausme EQ 'HC'.
                                        lv_produto = ls_orcamento_ref-passadas * ls_detailed-aareamanu * ls_zfmrclst-rcdos.
                                      ENDIF.
                                    ENDIF.

*                                      IF ls_zfmrclst-rcinp NE 'X'.
                                    ...
                                    ls_orcamento_new-versao = p_vers.
                                    INSERT INITIAL LINE INTO TABLE gt_update
                                      ASSIGNING FIELD-SYMBOL(<ls_inserir>).
                                    IF sy-subrc EQ 0.
                                      MOVE-CORRESPONDING ls_orcamento_new TO <ls_inserir>.
                                      <ls_inserir>-inserir = abap_true.
                                    ENDIF.
                                  ENDIF.
                                ENDIF.
...
*-- Registros devem ser ELIMINADOS da tabela ZABS_ORCAMENTO
                          IF lines( lt_orcamento ) GT lines( lt_tplnr_fl ).
                            LOOP AT lt_orcamento INTO ls_orcamento.
                              READ TABLE lt_tplnr_fl INTO ls_tplnr_fl
                                WITH KEY tplnr_fl = ls_orcamento-fazenda BINARY SEARCH.
                              IF sy-subrc NE 0.
                                INSERT INITIAL LINE INTO TABLE gt_update
                                  ASSIGNING <ls_eliminar>.
                                IF sy-subrc EQ 0.
                                  MOVE-CORRESPONDING ls_orcamento TO <ls_eliminar>.
                                  <ls_eliminar>-eliminar = abap_true.
                                ENDIF.
                            ...
                            IF sy-subrc EQ 0.
                              ...
                              WHILE sy-subrc EQ 0.
                                ...
                                IF sy-subrc NE 0.
                                  ...
                                  CLEAR: ls_orcamento.
                                  ls_orcamento-acnum = p_acnum.
                                  ls_orcamento-extwg = ls_matkl-extwg.
                                  ls_orcamento-matkl = ls_matkl-matkl.
                                  ls_orcamento-rcnum = ls_rchdr-rcnum.
                                  ls_orcamento-matnr = ls_zfmrclst-matnr_ins.

                                  CLEAR: lv_auxiliar, lv_passadas, lv_produto.
                                  READ TABLE lt_orcamento INTO ls_orcamento_ref
                                    WITH KEY acnum  = p_acnum
                                             extwg  = ls_matkl-extwg
                                             matkl  = ls_matkl-matkl
                                             rcnum  = ls_rchdr-rcnum
                                  ...
                                  ELSE.
                                    ...
                                    ls_orcamento-passadas = ls_orcamento_ref-passadas.
                                    ls_orcamento-rcdos    = ls_zfmrclst-rcdos.

                                    IF ls_zfmrclst-matnr(4) EQ 'TFOR'.
                                      ls_orcamento-aarea_form = ls_detailed-aareaform * ls_orcamento_ref-passadas.
*-- Calcula Quantidade de Produto
                                      IF ls_rchdr-ausme EQ 'VC'.
                                        lv_produto = ls_orcamento_ref-passadas * ls_detailed-bombasform * ls_zfmrclst-rcdos.
                                      ELSEIF ls_rchdr-ausme EQ 'HC'.
                                      ...
                                      ENDIF.
                                    ELSEIF ls_zfmrclst-matnr(4) EQ 'TMAN'.
                                      ls_orcamento-aarea_manu = ls_detailed-aareamanu * ls_orcamento_ref-passadas.
*-- Calcula Quantidade de Produto
                                      IF ls_rchdr-ausme EQ 'VC'.
                                        lv_produto = ls_orcamento_ref-passadas * ls_detailed-bombasmanu * ls_zfmrclst-rcdos.
                                      ELSEIF ls_rchdr-ausme EQ 'HC'.
                                    ...
                                    ls_orcamento-versao = p_vers.
                                    INSERT INITIAL LINE INTO TABLE gt_update ASSIGNING <ls_inserir>.
                                    IF sy-subrc EQ 0.
                                      MOVE-CORRESPONDING ls_orcamento TO <ls_inserir>.
                                      <ls_inserir>-inserir = abap_true.
                                    ENDIF.
                                  ENDIF.
                                ENDIF.
...
*--------------------------------------------------------------------
    ...
    ENDLOOP.
*-- BOC T_T.KONNO-04.08.21
*      REFRESH: lt_mensal, lt_mara, lt_orcamento, lt_matkl, lt_receitas.
*    ELSE.
*      REFRESH: lt_mensal, lt_mara, lt_orcamento, lt_matkl, lt_receitas.
*    ENDIF.
...
FORM fcode_save.
  ...
  DATA: lt_insert     TYPE STANDARD TABLE OF zabs_orcamento
                      INITIAL SIZE 0,
        lt_delete     TYPE STANDARD TABLE OF zabs_orcamento
                      INITIAL SIZE 0,
        lt_index_rows TYPE TABLE OF lvc_s_row,
        lv_titlebar   TYPE itex132,
        lv_question   TYPE itex132,
