...
DATA:
  lt_mchb         TYPE STANDARD TABLE OF ty_mchb,
...
CALL FUNCTION 'ZFM_GET_GRID_REFRESH'
  IMPORTING
    ev_grid_refresh = lv_grid_refresh.

CALL FUNCTION 'ZFM_SET_GRID_REFRESH'
  EXPORTING
    iv_grid_refresh = ''.

IF ref_grid_confirmations IS INITIAL OR lv_grid_refresh EQ abap_true.
