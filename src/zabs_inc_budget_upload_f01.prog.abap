...
*&---------------------------------------------------------------------*
*& Form AGRIPLAN_BUDGET_CREATE
*&---------------------------------------------------------------------*
*& Upload Agriplan's Budget Data
*&---------------------------------------------------------------------*
*&      --> T_SHEETS_OUT
*&---------------------------------------------------------------------*
FORM agriplan_budget_create USING lt_sheet TYPE /agri/t_excel_sheet.

  DATA: ref_upload TYPE REF TO zcl_abs_glupload_master_data.

  CREATE OBJECT ref_upload.
  ref_upload->agriplan_budget_create( EXPORTING it_table    = lt_sheet
