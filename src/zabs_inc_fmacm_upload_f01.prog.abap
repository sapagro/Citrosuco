...
*&---------------------------------------------------------------------*
*& Form ACCOMPLISHMENT_SHEET_CREATE
*&---------------------------------------------------------------------*
*& text
*&---------------------------------------------------------------------*
FORM accomplishment_sheet_create USING lt_sheet TYPE /agri/t_excel_sheet.

  DATA: ref_upload TYPE REF TO zcl_abs_glupload_master_data.

  CREATE OBJECT ref_upload.
  ref_upload->accomplishment_sheet_create( EXPORTING it_table    = lt_sheet
                                           IMPORTING et_messages = gt_message ).

ENDFORM.

*&---------------------------------------------------------------------*
*& Form ACCOMPLISHMENT_SHEET_UPDATE
*&---------------------------------------------------------------------*
*& text
*&---------------------------------------------------------------------*
FORM accomplishment_sheet_update USING lt_sheet TYPE /agri/t_excel_sheet.

  DATA: ref_upload TYPE REF TO zcl_abs_glupload_master_data.

  CREATE OBJECT ref_upload.
  ref_upload->accomplishment_sheet_update( EXPORTING it_table    = lt_sheet
                                           IMPORTING et_messages = gt_message ).
