...
CONSTANTS: c_program_acm   TYPE sy-repid VALUE 'SAPLZABS_FG_AGRIPLAN'.
...
CONSTANTS: BEGIN OF c_screen,
             ...
             budget               TYPE sy-dynnr VALUE '0308',
             cost                 TYPE sy-dynnr VALUE '0309',
             update_mass          TYPE sy-dynnr VALUE '0310',
             attributes           TYPE sy-dynnr VALUE '0311',
             recipe               TYPE sy-dynnr VALUE '0312',
             dose                 TYPE sy-dynnr VALUE '0313',
             qtde                 TYPE sy-dynnr VALUE '0314',
...
CONSTANTS : BEGIN OF c_fcode,
              ...
              tab_qtde              TYPE sy-ucomm VALUE 'TAB_QTDE',
...
CONSTANTS: BEGIN OF c_structure_name,
             work_list_header TYPE dd02l-tabname VALUE 'ZSC_FMACHDR_WL',
             items            TYPE dd02l-tabname VALUE 'ZSC_FMACITM_FCAT',
             vlcl             TYPE dd02l-tabname VALUE 'ZSC_FMACVLCL_FCAT',
             resumo           TYPE dd02l-tabname VALUE 'ZABS_STR_RESUMO_ORC_FCAT',
             custo            TYPE dd02l-tabname VALUE 'ZABS_STR_CUSTO_ORC_FCAT',
             receita          TYPE dd02l-tabname VALUE 'ZABS_STR_RECEITA_ORC_FCAT',
             qtde             TYPE dd02l-tabname VALUE 'ZABS_STR_QTDE_ORC_FCAT',
