...
*&---------------------------------------------------------------------*
  DATA: gt_productions TYPE STANDARD TABLE OF p9900,
        ...
        gt_output      TYPE STANDARD TABLE OF zabs_str_integra_hcm,
        gt_inactive    TYPE STANDARD TABLE OF zabs_str_integra_hcm,
...
*&---------------------------------------------------------------------*
  ...
  SELECT-OPTIONS: so_date  FOR /agri/fmacitm-zzcdate,
                  so_accom FOR /agri/fmachdr-accom,
                  so_time  FOR /agri/fmacitm-zzctime,
                  so_tplnr FOR /agri/fmacitm-tplnr,
                  so_aufnr FOR /agri/fmacitm-aufnr,
                  so_id    FOR /agri/fmacitm-idresource,
                  so_act   FOR /agri/fmacitm-idactvl.
