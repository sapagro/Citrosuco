...
*--assiagn Object to Dynamic table
  ...
  LOOP AT gt_mdhdr INTO DATA(ls_mdhdr).
    ...
    UNASSIGN <lfs_gsfstp>.
    READ TABLE gt_gsfstp ASSIGNING <lfs_gsfstp> WITH KEY stsma = ls_mdhdr-stsma
...
*--Field catalog prepare
  CALL FUNCTION 'LVC_FIELDCATALOG_MERGE'
    EXPORTING
      i_structure_name       = 'ZABS_STR_MASS_APPROV_AUX'
    CHANGING
      ct_fieldcat            = lt_fcat_aux
    EXCEPTIONS
      inconsistent_interface = 1
      program_error          = 2
      OTHERS                 = 3.
...
*--BOC-T_T.KONNO-05.28.21
    CASE ls_cabn-atnam.
      ...
      WHEN 'FAZ_QTD_REG_CENTRO'
        OR 'FAZ_QTD_REG_NORTE'
        OR 'FAZ_QTD_REG_SUL'
        OR 'FAZ_QTD_REG_EX_SUL'.
        ls_fcat-domname = 'ZABS_DOM_MENG30_0'.
      WHEN 'FAZ_QUANTIDADE_PLANTAS'.
        ls_fcat-domname = 'ZABS_DOM_MENG30_0'.
      WHEN 'FAZ_SAFRA'.
        ls_fcat-domname = 'ZABS_DOM_SAFRA_N'.
      WHEN 'FAZ_PERIODO'.
        ls_fcat-domname = 'ZABS_DOM_PERIODO'.
      WHEN 'FAZ_LAUDO'.
        ls_fcat-domname = 'ZABS_DOM_LAUDO'.
    ENDCASE.
    ...
    OR ls_fcat-domname = 'ZABS_DOM_SAFRA_N'
    OR ls_fcat-domname = 'ZABS_DOM_PERIODO'
    OR ls_fcat-domname = 'ZABS_DOM_LAUDO'
    OR ls_fcat-domname = 'FAZ_QUANTIDADE_PLANTAS'
    OR ls_fcat-domname = 'ZABS_DOM_NUMC10'.
      READ TABLE lt_fcat_aux INTO DATA(ls_fcat_ref)
...
*  ls_variant-report = 'ZABS_INC_MD_MASS_APPROVALS'.
  ls_variant-report = 'ZABS_REP_MD_MASS_APPROVALS'.
