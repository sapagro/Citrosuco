...
*--Table declarations.
TABLES : qals, qapp, mapl, /agri/glflot.
...
TYPES: BEGIN OF ty_row,
         prueflos   TYPE qplos,
         qm01_row   TYPE sytabix,
         qm01_field TYPE fieldname,
         qm03_field TYPE zabs_e_rqmerknr,
...
TYPES : BEGIN OF ty_qapp,
          ...
          userd1     TYPE qusrdats,
          usert1     TYPE qusrtims,
          ersteldat  TYPE erdat,
          erstelzeit TYPE qzeiterstl,
          aenderdat	 TYPE aedat,
          aenderzeit TYPE qzeitaend,
...
DATA : gt_mic_qm01     TYPE TABLE OF ty_mic,
       ...
       gt_qapp_all     TYPE tty_qapp,
       gt_last_created TYPE tty_qapp,
       gt_last_changed TYPE tty_qapp,
       gt_exception    TYPE tty_qapp,
       gt_qm01         TYPE tty_qapp,
*-- BOC T_T.KONNO-02.04.21
       gt_oper         TYPE STANDARD TABLE OF ty_oper INITIAL SIZE 0,
*-- EOC T_T.KONNO-02.04.21
...
DATA: go_tqm03 TYPE REF TO data.
