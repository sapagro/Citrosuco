*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZABS_VMCMPREASON
*   generation date: 29.04.2020 at 12:50:13
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZABS_VMCMPREASON    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZABS_VMCMPREASON'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZABS_VMCMPREASON_EXTRACT
TOTAL = ZABS_VMCMPREASON_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZABS_VMCMPREASON'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZABS_VMCMPREASON-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZABS_VMCMPREASON_EXTRACT
TOTAL = ZABS_VMCMPREASON_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZABS_VMCMPREASON-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZABS_VMCMPREASON'
...
TOTAL = ZABS_VMCMPREASON_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZABS_VMCMPREASON-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZABS_VMCMPREASON-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZABS_VMCMPREASON'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZABS_VMCMPREASON-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZABS_VMCMPREASON_EXTRACT
TOTAL = ZABS_VMCMPREASON_TOTAL
