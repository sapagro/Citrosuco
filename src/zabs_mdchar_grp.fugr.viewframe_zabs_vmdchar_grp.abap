*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZABS_VMDCHAR_GRP
*   generation date: 01.05.2020 at 10:23:35
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZABS_VMDCHAR_GRP    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZABS_VMDCHAR_GRP'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZABS_VMDCHAR_GRP_EXTRACT
TOTAL = ZABS_VMDCHAR_GRP_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZABS_VMDCHAR_GRP'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZABS_VMDCHAR_GRP-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZABS_VMDCHAR_GRP_EXTRACT
TOTAL = ZABS_VMDCHAR_GRP_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZABS_VMDCHAR_GRP-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZABS_VMDCHAR_GRP'
...
TOTAL = ZABS_VMDCHAR_GRP_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZABS_VMDCHAR_GRP-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZABS_VMDCHAR_GRP-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZABS_VMDCHAR_GRP'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZABS_VMDCHAR_GRP-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZABS_VMDCHAR_GRP_EXTRACT
TOTAL = ZABS_VMDCHAR_GRP_TOTAL
