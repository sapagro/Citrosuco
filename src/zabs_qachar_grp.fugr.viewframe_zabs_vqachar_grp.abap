*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZABS_VQACHAR_GRP
*   generation date: 23.04.2020 at 14:07:51
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZABS_VQACHAR_GRP    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZABS_VQACHAR_GRP'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZABS_VQACHAR_GRP_EXTRACT
TOTAL = ZABS_VQACHAR_GRP_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZABS_VQACHAR_GRP'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZABS_VQACHAR_GRP-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZABS_VQACHAR_GRP_EXTRACT
TOTAL = ZABS_VQACHAR_GRP_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZABS_VQACHAR_GRP-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZABS_VQACHAR_GRP'
...
TOTAL = ZABS_VQACHAR_GRP_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZABS_VQACHAR_GRP-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZABS_VQACHAR_GRP-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZABS_VQACHAR_GRP'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZABS_VQACHAR_GRP-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZABS_VQACHAR_GRP_EXTRACT
TOTAL = ZABS_VQACHAR_GRP_TOTAL
