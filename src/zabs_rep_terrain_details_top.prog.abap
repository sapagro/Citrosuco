...
DATA: gt_terrain_dtls    TYPE tty_terrain_dtls,
      ...
      gt_farm_subtot_f   TYPE zabs_tty_farm_subtot,
      gt_farm_subtot_t   TYPE zabs_tty_farm_subtot,
...
**             p_werks  TYPE iwerk OBLIGATORY,
**             p_region TYPE atwrt OBLIGATORY. " Wave 3 changes commented
