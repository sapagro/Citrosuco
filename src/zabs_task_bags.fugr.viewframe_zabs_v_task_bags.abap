*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZABS_V_TASK_BAGS
*   generation date: 07.05.2020 at 13:12:15
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZABS_V_TASK_BAGS    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZABS_V_TASK_BAGS'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZABS_V_TASK_BAGS_EXTRACT
TOTAL = ZABS_V_TASK_BAGS_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZABS_V_TASK_BAGS'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZABS_V_TASK_BAGS-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZABS_V_TASK_BAGS_EXTRACT
TOTAL = ZABS_V_TASK_BAGS_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZABS_V_TASK_BAGS-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZABS_V_TASK_BAGS'
...
TOTAL = ZABS_V_TASK_BAGS_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZABS_V_TASK_BAGS-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZABS_V_TASK_BAGS-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZABS_V_TASK_BAGS'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZABS_V_TASK_BAGS-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZABS_V_TASK_BAGS_EXTRACT
TOTAL = ZABS_V_TASK_BAGS_TOTAL
