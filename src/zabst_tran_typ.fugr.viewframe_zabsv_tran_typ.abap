*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZABSV_TRAN_TYP
*   generation date: 09.11.2020 at 05:15:33
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZABSV_TRAN_TYP      .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZABSV_TRAN_TYP'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZABSV_TRAN_TYP_EXTRACT
TOTAL = ZABSV_TRAN_TYP_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZABSV_TRAN_TYP'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZABSV_TRAN_TYP-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZABSV_TRAN_TYP_EXTRACT
TOTAL = ZABSV_TRAN_TYP_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZABSV_TRAN_TYP-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZABSV_TRAN_TYP'
...
TOTAL = ZABSV_TRAN_TYP_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZABSV_TRAN_TYP-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZABSV_TRAN_TYP-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZABSV_TRAN_TYP'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZABSV_TRAN_TYP-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZABSV_TRAN_TYP_EXTRACT
TOTAL = ZABSV_TRAN_TYP_TOTAL
