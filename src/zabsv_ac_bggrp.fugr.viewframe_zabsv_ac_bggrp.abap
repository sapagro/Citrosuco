*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZABSV_AC_BGGRP
*   generation date: 25.09.2020 at 01:44:41
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZABSV_AC_BGGRP      .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZABSV_AC_BGGRP'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZABSV_AC_BGGRP_EXTRACT
TOTAL = ZABSV_AC_BGGRP_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZABSV_AC_BGGRP'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZABSV_AC_BGGRP-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZABSV_AC_BGGRP_EXTRACT
TOTAL = ZABSV_AC_BGGRP_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZABSV_AC_BGGRP-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZABSV_AC_BGGRP'
...
TOTAL = ZABSV_AC_BGGRP_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZABSV_AC_BGGRP-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZABSV_AC_BGGRP-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZABSV_AC_BGGRP'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZABSV_AC_BGGRP-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZABSV_AC_BGGRP_EXTRACT
TOTAL = ZABSV_AC_BGGRP_TOTAL
