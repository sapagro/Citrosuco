*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZABSV_ACBRP_ELOG
*   generation date: 18.09.2020 at 09:57:51
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZABSV_ACBRP_ELOG    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZABSV_ACBRP_ELOG'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZABSV_ACBRP_ELOG_EXTRACT
TOTAL = ZABSV_ACBRP_ELOG_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZABSV_ACBRP_ELOG'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZABSV_ACBRP_ELOG-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZABSV_ACBRP_ELOG_EXTRACT
TOTAL = ZABSV_ACBRP_ELOG_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZABSV_ACBRP_ELOG-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZABSV_ACBRP_ELOG'
...
TOTAL = ZABSV_ACBRP_ELOG_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZABSV_ACBRP_ELOG-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZABSV_ACBRP_ELOG-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZABSV_ACBRP_ELOG'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZABSV_ACBRP_ELOG-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZABSV_ACBRP_ELOG_EXTRACT
TOTAL = ZABSV_ACBRP_ELOG_TOTAL
