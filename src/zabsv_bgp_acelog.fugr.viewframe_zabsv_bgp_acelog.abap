*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZABSV_BGP_ACELOG
*   generation date: 01.12.2020 at 09:22:10
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZABSV_BGP_ACELOG    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZABSV_BGP_ACELOG'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZABSV_BGP_ACELOG_EXTRACT
TOTAL = ZABSV_BGP_ACELOG_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZABSV_BGP_ACELOG'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZABSV_BGP_ACELOG-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZABSV_BGP_ACELOG_EXTRACT
TOTAL = ZABSV_BGP_ACELOG_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZABSV_BGP_ACELOG-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZABSV_BGP_ACELOG'
...
TOTAL = ZABSV_BGP_ACELOG_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZABSV_BGP_ACELOG-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZABSV_BGP_ACELOG-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZABSV_BGP_ACELOG'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZABSV_BGP_ACELOG-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZABSV_BGP_ACELOG_EXTRACT
TOTAL = ZABSV_BGP_ACELOG_TOTAL
