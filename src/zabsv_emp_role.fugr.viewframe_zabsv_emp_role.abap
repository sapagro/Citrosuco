*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZABSV_EMP_ROLE
*   generation date: 25.05.2020 at 01:49:36
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZABSV_EMP_ROLE      .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZABSV_EMP_ROLE'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZABSV_EMP_ROLE_EXTRACT
TOTAL = ZABSV_EMP_ROLE_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZABSV_EMP_ROLE'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZABSV_EMP_ROLE-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZABSV_EMP_ROLE_EXTRACT
TOTAL = ZABSV_EMP_ROLE_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZABSV_EMP_ROLE-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZABSV_EMP_ROLE'
...
TOTAL = ZABSV_EMP_ROLE_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZABSV_EMP_ROLE-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZABSV_EMP_ROLE-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZABSV_EMP_ROLE'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZABSV_EMP_ROLE-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZABSV_EMP_ROLE_EXTRACT
TOTAL = ZABSV_EMP_ROLE_TOTAL
