*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZABSV_HDR_ACCOM
*   generation date: 18.09.2020 at 07:07:08
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZABSV_HDR_ACCOM     .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZABSV_HDR_ACCOM'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZABSV_HDR_ACCOM_EXTRACT
TOTAL = ZABSV_HDR_ACCOM_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZABSV_HDR_ACCOM'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZABSV_HDR_ACCOM-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZABSV_HDR_ACCOM_EXTRACT
TOTAL = ZABSV_HDR_ACCOM_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZABSV_HDR_ACCOM-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZABSV_HDR_ACCOM'
...
TOTAL = ZABSV_HDR_ACCOM_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZABSV_HDR_ACCOM-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZABSV_HDR_ACCOM-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZABSV_HDR_ACCOM'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZABSV_HDR_ACCOM-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZABSV_HDR_ACCOM_EXTRACT
TOTAL = ZABSV_HDR_ACCOM_TOTAL
