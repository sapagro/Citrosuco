*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZABSV_NRPLANNING
*   generation date: 16.07.2019 at 01:20:19
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZABSV_NRPLANNING    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZABSV_NRPLANNING'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZABSV_NRPLANNING_EXTRACT
TOTAL = ZABSV_NRPLANNING_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZABSV_NRPLANNING'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZABSV_NRPLANNING-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZABSV_NRPLANNING_EXTRACT
TOTAL = ZABSV_NRPLANNING_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZABSV_NRPLANNING-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZABSV_NRPLANNING'
...
TOTAL = ZABSV_NRPLANNING_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZABSV_NRPLANNING-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZABSV_NRPLANNING-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZABSV_NRPLANNING'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZABSV_NRPLANNING-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZABSV_NRPLANNING_EXTRACT
TOTAL = ZABSV_NRPLANNING_TOTAL
