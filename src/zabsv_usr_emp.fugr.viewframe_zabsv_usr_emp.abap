*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZABSV_USR_EMP
*   generation date: 11.05.2020 at 07:26:06
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZABSV_USR_EMP       .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZABSV_USR_EMP'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZABSV_USR_EMP_EXTRACT
TOTAL = ZABSV_USR_EMP_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZABSV_USR_EMP'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZABSV_USR_EMP-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZABSV_USR_EMP_EXTRACT
TOTAL = ZABSV_USR_EMP_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZABSV_USR_EMP-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZABSV_USR_EMP'
...
TOTAL = ZABSV_USR_EMP_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZABSV_USR_EMP-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZABSV_USR_EMP-UPD_FLAG NE SPACE.
