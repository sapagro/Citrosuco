*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZABSV_VTCHDR
*   generation date: 26.06.2019 at 07:47:21
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZABSV_VTCHDR        .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZABSV_VTCHDR'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZABSV_VTCHDR_EXTRACT
TOTAL = ZABSV_VTCHDR_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZABSV_VTCHDR'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZABSV_VTCHDR-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZABSV_VTCHDR_EXTRACT
TOTAL = ZABSV_VTCHDR_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZABSV_VTCHDR-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZABSV_VTCHDR'
...
TOTAL = ZABSV_VTCHDR_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZABSV_VTCHDR-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZABSV_VTCHDR-UPD_FLAG NE SPACE.
