*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZABSV_VTCITM
*   generation date: 26.06.2019 at 08:45:09
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZABSV_VTCITM        .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZABSV_VTCITM'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZABSV_VTCITM_EXTRACT
TOTAL = ZABSV_VTCITM_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZABSV_VTCITM'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZABSV_VTCITM-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZABSV_VTCITM_EXTRACT
TOTAL = ZABSV_VTCITM_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZABSV_VTCITM-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZABSV_VTCITM'
...
TOTAL = ZABSV_VTCITM_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZABSV_VTCITM-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZABSV_VTCITM-UPD_FLAG NE SPACE.
