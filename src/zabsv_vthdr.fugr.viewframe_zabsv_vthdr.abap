*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZABSV_VTHDR
*   generation date: 26.06.2019 at 07:45:10
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZABSV_VTHDR         .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZABSV_VTHDR'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZABSV_VTHDR_EXTRACT
TOTAL = ZABSV_VTHDR_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZABSV_VTHDR'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZABSV_VTHDR-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZABSV_VTHDR_EXTRACT
TOTAL = ZABSV_VTHDR_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZABSV_VTHDR-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZABSV_VTHDR'
...
TOTAL = ZABSV_VTHDR_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZABSV_VTHDR-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZABSV_VTHDR-UPD_FLAG NE SPACE.
