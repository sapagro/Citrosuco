class ZCL_ABS_GLUPLOAD_MASTER_DATA definition
  public
  final
  create public .
...
*"* public components of class ZCL_ABS_GLUPLOAD_MASTER_DATA
...
protected section.
*"* protected components of class ZCL_ABS_GLUPLOAD_MASTER_DATA
*"* do not include other source files here!!!
private section.
...
*"* private components of class ZCL_ABS_GLUPLOAD_MASTER_DATA
*"* do not include other source files here!!!
...
CLASS ZCL_ABS_GLUPLOAD_MASTER_DATA IMPLEMENTATION.
...
METHOD measurement_document_create.
  ...
  IF lt_md02[] IS NOT INITIAL.
    SELECT c~atinn, c~atnam, c~atfor,
          c~anzst, c~anzdz, g~atbez_uc AS atbez
