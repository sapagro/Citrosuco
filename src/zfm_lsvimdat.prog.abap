...
DATA: user_button_used TYPE abap_bool VALUE abap_false.
...
DATA: vim_translate_flag TYPE bool VALUE abap_false.

* Function code exclusion
TYPES: tt_excl_funct TYPE STANDARD TABLE OF vimexclfun.

* Active screen restrictions
DATA: gt_restrictions TYPE if_sscui_adaptation=>tt_modify_scr.
