...
FORM vlcl_grid_update .
  ...
  DATA: lt_glmdhdr     TYPE /agri/t_glmdhdr,
        lt_glmdatv     TYPE /agri/t_glmdatv,
        lwa_vlcl       TYPE zsc_fmacvlcl,
...
*-- BOC 10.16.20-T_T.KONNO
    IF lwa_vcl_layout-matnr CS '0150'.
      IF lwa_vcl_layout-acdis IS NOT INITIAL.
        lv_float = lwa_vcl_layout-acidt * 1000 * lwa_vcl_layout-acarx.
        lwa_vcl_layout-acqtb = lv_float / lwa_vcl_layout-acdis.
        lv_valor = lwa_vcl_layout-acidt * 1000 * lwa_vcl_layout-acarx.
        lv_valor = lv_valor / lwa_vcl_layout-acdis.
      ENDIF.
    ELSE.
      IF lwa_vcl_layout-acdis IS NOT INITIAL.
...
FORM volumen_calda_create.
  ...
  DATA: lt_glflcma  TYPE /agri/t_glflcma,
...
*Volume de Calda/HA =  Volume Total de Calda/Qtde. de hectares
    ...
    ENDIF.
**Commented below lines Start INC0023157 T_C.KARANAM
**    DATA(lv_limite) = 4000.
...
**    ENDIF.
**Commented above lines End INC0023157
  ENDIF.
*...EOC-T_T.KONNO
...
*-- BOC 10.16.20-T_T.KONNO
    IF <lwa_vlcl>-matnr CS '0150'.
      IF <lwa_vlcl>-acdis IS NOT INITIAL.
        lv_float = <lwa_vlcl>-acidt * 1000 * <lwa_vlcl>-acarx.
        <lwa_vlcl>-acqtb = lv_float / <lwa_vlcl>-acdis.
        lv_valor = <lwa_vlcl>-acidt * 1000 * <lwa_vlcl>-acarx.
        lv_valor = lv_valor / <lwa_vlcl>-acdis.
      ENDIF.
    ELSE.
      IF <lwa_vlcl>-acdis IS NOT INITIAL.
