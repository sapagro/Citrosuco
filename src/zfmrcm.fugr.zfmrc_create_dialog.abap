...
**  CLEAR: /agri/1899SC_FMRCHDR, /agri/s_glflcma,
**         gs_variables-external_dialog, gs_variables-mass_action,
**         gs_variables-cancelled.
**
**  /agri/1899SC_FMRCHDR-aslvl = gs_variables-measurement_level = i_aslvl.
**
**  REFRESH: gt_mdsnp.
...
**      MOVE-CORRESPONDING lwa_mdsnp TO gs_RCDOC_infocus-x-RCHDR.
...
**         WHERE tplnr_fl EQ gs_RCDOC_infocus-x-RCHDR-tplnr_fl
**           AND contr    EQ gs_RCDOC_infocus-x-RCHDR-contr.
**      ENDIF.
