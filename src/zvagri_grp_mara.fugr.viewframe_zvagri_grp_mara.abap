*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZVAGRI_GRP_MARA
*   generation date: 30.08.2019 at 11:20:58
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZVAGRI_GRP_MARA     .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZVAGRI_GRP_MARA'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZVAGRI_GRP_MARA_EXTRACT
TOTAL = ZVAGRI_GRP_MARA_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZVAGRI_GRP_MARA'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZVAGRI_GRP_MARA-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVAGRI_GRP_MARA_EXTRACT
TOTAL = ZVAGRI_GRP_MARA_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZVAGRI_GRP_MARA-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZVAGRI_GRP_MARA'
...
TOTAL = ZVAGRI_GRP_MARA_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZVAGRI_GRP_MARA-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZVAGRI_GRP_MARA-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZVAGRI_GRP_MARA'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZVAGRI_GRP_MARA-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVAGRI_GRP_MARA_EXTRACT
TOTAL = ZVAGRI_GRP_MARA_TOTAL
