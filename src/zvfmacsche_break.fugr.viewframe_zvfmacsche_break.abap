*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZVFMACSCHE_BREAK
*   generation date: 23.10.2019 at 19:30:51
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZVFMACSCHE_BREAK    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZVFMACSCHE_BREAK'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZVFMACSCHE_BREAK_EXTRACT
TOTAL = ZVFMACSCHE_BREAK_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZVFMACSCHE_BREAK'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZVFMACSCHE_BREAK-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVFMACSCHE_BREAK_EXTRACT
TOTAL = ZVFMACSCHE_BREAK_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZVFMACSCHE_BREAK-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZVFMACSCHE_BREAK'
...
TOTAL = ZVFMACSCHE_BREAK_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZVFMACSCHE_BREAK-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZVFMACSCHE_BREAK-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZVFMACSCHE_BREAK'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZVFMACSCHE_BREAK-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVFMACSCHE_BREAK_EXTRACT
TOTAL = ZVFMACSCHE_BREAK_TOTAL
