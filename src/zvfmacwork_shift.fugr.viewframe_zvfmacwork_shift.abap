*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZVFMACWORK_SHIFT
*   generation date: 23.10.2019 at 19:30:03
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZVFMACWORK_SHIFT    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZVFMACWORK_SHIFT'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZVFMACWORK_SHIFT_EXTRACT
TOTAL = ZVFMACWORK_SHIFT_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZVFMACWORK_SHIFT'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZVFMACWORK_SHIFT-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVFMACWORK_SHIFT_EXTRACT
TOTAL = ZVFMACWORK_SHIFT_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZVFMACWORK_SHIFT-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZVFMACWORK_SHIFT'
...
TOTAL = ZVFMACWORK_SHIFT_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZVFMACWORK_SHIFT-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZVFMACWORK_SHIFT-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZVFMACWORK_SHIFT'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZVFMACWORK_SHIFT-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVFMACWORK_SHIFT_EXTRACT
TOTAL = ZVFMACWORK_SHIFT_TOTAL
